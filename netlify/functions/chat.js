...
线上看诊服务费：
- 初诊线上看诊 (30分钟)：RM 68。适合第一次看诊或全新问题。包含完整病情评估、体质分析与调理建议。
- 深度调理线上看诊 (31-60分钟)：RM 128。适合病情复杂、多系统错杂，或需要进行深度心理、饮食与生活方式梳理的患者。
- 方药调整微调 (15分钟视讯)：RM 38。适合同一问题后续跟进。通过视讯沟通，根据身体反馈调整建议。
- 月度调理配套 (无使用期限)：RM 168。包含 1次初诊 + 3次复诊 + 1次气功指导（赠送：单次气功指导 价值 RM 68）。
- 季度调理配套 (无使用期限)：RM 388。包含 1次初诊 + 9次复诊 + 2次气功指导（赠送：气功指导 总值 RM 136）。

气功指导与抗压配套：
- 单次自然门气功指导与答疑：RM 68。包含气功理论基础讲解与实操动作指导纠正，每次约 30 分钟。
- 月度入门配套：RM 198。专为零基础初学者设计，在一个月内逐步建立气功练习习惯与基本动作掌握，调节初期压力。
- 自然门气功季度调理配套：RM 488。包含 1次中医体质与练功适应性评估 + 6次气功指导与答疑 + 6次练功反馈微调 + 1次阶段复盘。适合希望建立稳定练习习惯、改善睡眠节律、压力状态、肠胃功能与体质调理的人群。（注：若需完整中医看诊、处方或慢病方案分析，需另行预约线上看诊）。
